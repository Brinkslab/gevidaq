...
class WaveformGenerator(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.Galvo_samples = self.finalwave_640 = self.finalwave_488 = (
            self.finalwave_532
        ) = self.finalwave_patch = (
            self.handle_viewbox_coordinate_position_array_expanded_forDaq_waveform
        ) = None
        self.finalwave_cameratrigger = self.final_galvotrigger = (
            self.finalwave_blankingall
        ) = self.finalwave_640blanking = self.finalwave_532blanking = (
            self.finalwave_488blanking
        ) = self.finalwave_Perfusion_8 = self.finalwave_Perfusion_7 = (
            self.finalwave_Perfusion_6
        ) = self.finalwave_Perfusion_2 = self.finalwave_2Pshutter = (
            self.finalwave_DMD_trigger
        ) = None
    ...
    def generate_digital(self, channel):
        ...
        try:
            ...
            print(f"Error missing frequency, {e}")
